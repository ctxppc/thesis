(
	...
	(
		...
		in: do(
			...
			set(abstract(ls.self), to: register(invocationData, cap))
			set(abstract(ls.rec), to: abstract(ls.self))
			getElement(s32, of: abstract(ls.rec), offset: constant(0), to: abstract(ls.lhs))
			set(abstract(ls.rhs), to: constant(1))
			compute(abstract(ls.newValue), abstract(ls.lhs), add, abstract(ls.rhs))
			set(abstract(ls.rec$2), to: abstract(ls.self))
			set(abstract(ls.val$1), to: abstract(ls.newValue))
			setElement(s32, of: abstract(ls.rec$2), offset: constant(0), to: abstract(ls.val$1))
			set(abstract(df.result$2), to: abstract(ls.newValue))
