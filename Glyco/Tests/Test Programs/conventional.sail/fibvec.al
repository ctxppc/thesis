		...
		in: do(
			...
			if(
				...
				then: do(
					...
					compute(abstract(sv.offset$1), abstract(ls.idx$3), sll, constant(2))
					getElement(s32, of: abstract(ls.vec$3), offset: abstract(sv.offset$1), to: abstract(ls.lhs$2))
					...
					compute(abstract(sv.offset$2), abstract(ls.idx$4), sll, constant(2))
					getElement(s32, of: abstract(ls.vec$4), offset: abstract(sv.offset$2), to: abstract(ls.rhs$3))
					compute(abstract(ls.elem$1), abstract(ls.lhs$2), add, abstract(ls.rhs$3))
					compute(abstract(sv.offset$3), abstract(ls.idx$2), sll, constant(2))
					setElement(s32, of: abstract(ls.vec$2), offset: abstract(sv.offset$3), to: abstract(ls.elem$1))
