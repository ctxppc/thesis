		...
		in: do(
			...
			if(
				...
				then: do(
					...
					compute(abstract(sv.offset$1), abstract(ls.idx$2), sll, constant(2))
					getElement(s32, of: abstract(ls.vec$2), offset: abstract(sv.offset$1), to: abstract(ls.lhs$1))
					...
					compute(abstract(sv.offset$2), abstract(ls.idx$3), sll, constant(2))
					getElement(s32, of: abstract(ls.vec$3), offset: abstract(sv.offset$2), to: abstract(ls.rhs$1))
					compute(abstract(ls.elem), abstract(ls.lhs$1), add, abstract(ls.rhs$1))
					compute(abstract(sv.offset$3), abstract(ls.idx$1), sll, constant(2))
					setElement(s32, of: abstract(ls.vec$1), offset: abstract(sv.offset$3), to: abstract(ls.elem))
