(
	...
	procedures: (
		...
		in: do(
			...
			allocateBuffer(bytes: 120, into: abstract(ls.arg2))
			set(register(a0), to: abstract(ls.arg0))
			set(register(a1), to: abstract(ls.arg1))
		...
		in: do(
			...
			if(
				...
				then: do(
					...
					compute(abstract(ls.idx), sll, constant(4), to: abstract(sv.offset))
					...
					compute(abstract(ls.idx$1), sll, constant(4), to: abstract(sv.offset$1))
					...
					compute(abstract(ls.idx$2), sll, constant(4), to: abstract(sv.offset$2))
					...
					compute(abstract(ls.idx$3), sll, constant(4), to: abstract(sv.offset$3))
