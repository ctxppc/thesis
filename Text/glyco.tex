...
An effect's liveness set and conflict graph \emph{at entry} can be derived from the effect's liveness set and conflict graph \emph{at exit} using the following 2 rules.
...
Since the liveness set and conflict graph at entry depends on the liveness set and conflict graph at exit, the program is traversed backwards, i.e., against the direction of execution and towards the beginning of the program or procedure.
