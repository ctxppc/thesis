...
\begin{itemize}[noitemsep]
	...
	\item which registers a procedure can use freely but cannot know if their contents will be preserved across a procedure call (\g{cersaved});
	\item which registers a procedure can only use after saving their previous contents and restoring them after use (\g{ceesaved});
	% TODO
\end{itemize}
