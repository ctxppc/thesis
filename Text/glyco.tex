...
The following EX program computes the 30th number in the Fibonacci sequence starting with 0 and 1:\footnote{The \iil/sealed: false/ attribute on parameters is introduced in the next chapter as part of Glyco 0.2 and can be ignored for now.}
...
\todo{Define records, vectors, and let-bindings; show examples. It's late to introduce them in lower ILs since they're also part of EX's vocabulary and feature set.}
...
\ilfile[highlightlines={5-8}, samepage=true]{Programs/42.sv}
...
The results of the \iil/sll/ (logical left shift) operations in this program are statically computed as part of an optimisation pass in a lower \g{il}.
...
\todo{Maybe add a flow diagram for extra clarification?}
