...
\ilfile{Programs/sequences.sv}
is \lowered{} to the following ID program:
\ilfile{Programs/sequences.id}
\todo{Highlight corresponding parts.}
...
\ilfile{Programs/coalescable.al}
...
\ilfile{Programs/ifproc.cd}
is \lowered{} to the PR program
\ilfile{Programs/ifproc.pr}
