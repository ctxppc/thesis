...
Later chapters explore extensions and changes to this first version of the compiler. A full language reference of the final compiler can be found in \cref{ch:grammar}.
