...
\begin{grammar}
	\footnotesize
				...
				\par
				<CL.ObjectType> ::=
							"("<TypeName>, "initialState:" <[RecordEntry]>, "initialiser:" <Initialiser>, "methods:" <[Method]>")"
				\par
				<CL.Effect> ::=
						"do""("<[Effect]>")"
...
\begin{grammar}
	\footnotesize
				...
				<OB.Value> ::=
						...
						| "evaluate""("<Value>, <[Value]>")"
						| "message""("<Value>, <Method.Name>, <[Value]>")"
						| "sendableMessage""("<Value>, <Method.Name>")"
						| "if""("<Predicate>, "then:" <Value>, "else:" <Value>")"
						| "let""("<[Definition]>, "in:" <Value>")"
						| "letType""("<[TypeDefinition]>, "in:" <Value>")"
						| "do""("<[Effect]>, "then:" <Value>")"
				...
				<OB.CapabilityType> ::=
						...
						| "object""("<TypeName>")"
						| "boundMethod""(""takes:" <[Parameter]>, "returns:" <ValueType>")"
						| "seal"
				\par
				<OB.Method> ::=
							"("<Symbol>, "takes:" <[Parameter]>, "returns:" <ValueType>, "in:" <Result>")"
