...
\begin{enumerate}
	...
	\item \label{itm:retseal} The caller creates a unique \g{sealcap} and stores it in its call frame. This capability is itself unsealed and will be used to ensure that the callee can only return to the caller once.\footnote{This step is not part of Glyco 0.2 but instead added in a later version.} % TODO: Remove if cherry-picking change into Glyco 0.2.
