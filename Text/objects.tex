...
A second feature is the ability to name types, by either defining a nominal type or a named structural type, in a new \g{il} \textbf{NT} (Named Types) above Λ. A value in NT can be
\begin{itemize}[nosep]
...
% TODO: Add valid NT example program.
