...
\newdualentry{gccc}{GCCC}{Glyco Conventional Calling Convention}{a \cc{} implemented in Glyco that is similar to a RISC-V \g{cc}}
...
\newglossaryentry{bblock}{
	name=basic block,
	description={a labelled sequence of effects that is executed from beginning to end, before jumping or branching to itself or other code. No effect in the block is labelled or is a jump, call, or branch}
}
