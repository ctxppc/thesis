...
\lstset{ 
	...
	morekeywords={*, let, set, source, evaluate, constant, s32, u8, vectorCap, cap, value, location, binary, relation, true, false, vector, record, element, getElement, createVector, getField, createRecord, compute, field, createBuffer, setElement, getElement, pushScope, popScope, abstract, setField, registerDatum, code, named, le, add, sub, mul, call, branch},
	keywordstyle=\color{BlueViolet},
	moreemph={then, takes, returns, functions, procedures, in, to, of, count, capability, scoped, index, bytes, sealed, offset, locals, name, returnPoint, else},
