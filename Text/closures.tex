...
\Cref{sct:cls-trad} sets out how closures are usually implemented and what problems these methods suffer from. \Cref{sct:cls-sealed} then presents a sealed object-based solution and a new \g{il}. Finally, \cref{sct:cls-changes} lists the changes in the compiler and evaluates the nanopass approach's impact on the codebase.
