...
\paragraph{Continuations} Heap-allocated call frames (\g{ghscc}) and closures can be naturally generalised to first-class support for continuations. We foresee two possible approaches.
